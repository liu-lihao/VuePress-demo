...
module.exports = {
  title: 'VuePressDemo', // TODO 改个标题~
  description: '这是一个VuePressDemo项目的描述', // TODO 给个描述~
  port: 8888,
  head: [
    // 此处可以使用 script 引用 js
  ...
  base: '/vuepress-demo/', // TODO 如果你项目放在域名的根目录，请清空，否则请加上路径~
  // TODO 例如：https://liu-lihao.github.io/vuepress-demo/index.html
  // TODO 则 base: '/vuepress-demo/'
  locales: {
    '/': {
      lang: 'zh-CN',
    }
  ...
  themeConfig: {
    ...
    nav: [ // TODO 这里定制你的顶部导航~
      ...
      {
        text: '我的两本书', items: [
          { text: '第一本：语法', link: '/my-book-one/aa' },
          { text: '第二本：配置', link: '/my-book-two/aa' }
        ]
      },
